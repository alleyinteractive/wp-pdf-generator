...
function register_example_slotfills_scripts(): void {
	...
	*/
	 ...
	 * wp_register_script(
	 *     'wp-pdf-generator-example_slotfills',
	 *     plugins_url( 'index.js', __FILE__ ),
	 *     $asset_file['dependencies'],
	 *     $asset_file['version'],
	 *     true
	 * );
	 * wp_set_script_translations( 'wp-pdf-generator-example_slotfills', 'wp-pdf-generator' );
	 */
}
...
function action_enqueue_example_slotfills_assets(): void {
	wp_enqueue_script( 'wp-pdf-generator-example_slotfills' );
}
